...
gren=$(tput setaf 2)
yellow=$(tput setaf 3)
SCPdir="/etc/ElementManager" && [[ ! -d ${SCPdir} ]] && exit 1
SCTemp="/etc/ElementManager/temp" && [[ ! -d ${SCTemp} ]] && exit 1
...
msg() { ##-->> COLORES, TITULO, BARRAS
  ...
  [[ ! -e /etc/ElementManager/temp/version_instalacion ]] && printf '1\n' >/etc/ElementManager/temp/version_instalacion
  v11=$(cat /etc/ElementManager/temp/version_actual)
  v22=$(cat /etc/ElementManager/temp/version_instalacion)
  if [[ $v11 = $v22 ]]; then
    vesaoSCT="\e[1;31m[\033[1;37m Versión: \033[1;32m $v22 \033[1;31m]"
  else
    vesaoSCT="\e[1;31m[\e[31m ACTUALIZAR \e[25m\033[1;31m]"
  fi
  ##-->> COLORES
  local colors="/etc/ElementManager/colors"
  if [[ ! -e $colors ]]; then
  ...
  "-bar2" | "-bar") cor="${COLOR[4]}════════════════════════════════════════════════════" && echo -e "${SINCOLOR}${cor}${SINCOLOR}" ;;
  # Centrar texto
  -tit) echo -e " \e[48;5;214m\e[38;5;0m 🚀 ELEMENT | MANAGER 💻  \e[0m  $vesaoSCT" ;;
  esac
}
#--- INFO DE SISTEMA
os_system() {
...
#--- FUNCION IP ACTUAL
fun_ip() {
  if [[ -e /etc/ElementManager/MEUIPvps ]]; then
    IP="$(cat /etc/ElementManager/MEUIPvps)"
  else
    MEU_IP=$(wget -qO- ifconfig.me)
    echo "$MEU_IP" >/etc/ElementManager/MEUIPvps
  fi
}
...
##-->> CONTADOR DE CUENTAS
if [[ $(find /etc/ElementManager/temp/ -name "sshtotal" -execdir test -f {} \; -print -quit) ]]; then
  SSH4=$(</etc/ElementManager/temp/sshtotal)
else
  SSH4="0"
fi
...
if [[ $(find /etc/ElementManager/ -name "RegV2ray" -execdir test -f {} \; -print -quit) ]]; then
  v2ray=$(wc -l </etc/ElementManager/RegV2ray)
else
  v2ray="0"
fi
on="\033[93m[\033[1;32m ON \033[93m]" && off="\033[93m[ \033[1;31mOFF \033[93m]"
[[ $(ps x | grep badvpn | grep -v grep | awk '{print $1}') ]] && badvpn=$on || badvpn=$off
VERY="$(ps aux | grep "/etc/ElementManager/menu.sh verificar" | grep -v grep)"
VERY2="$(ps aux | grep "/etc/ElementManager/menu.sh desbloqueo" | grep -v grep)"
VERY3="$(ps aux | grep "${SCPdir}/menu.sh monitorservi" | grep -v grep)"
VERY4="$(ps aux | grep "${SCPdir}/menu.sh autolim" | grep -v grep)"
[[ -e "/etc/ElementManager/temp/T-Lim" ]] && limseg="$(less /etc/ElementManager/temp/T-Lim)"
...
#ONLINES
[[ -e /etc/ElementManager/temp/USRonlines ]] && {
  msg -bar
  onssh=$(cat /etc/ElementManager/temp/USRonlines)
  echo -ne "\033[1;32m CONECTADOS:\033[1;36m[\e[97m $onssh \033[1;36m]"
}
#EXPIRADOS
[[ -e /etc/ElementManager/temp/USRexpired ]] && {
  expi=$(cat /etc/ElementManager/temp/USRexpired)
  echo -ne "\e[1;31m EXPIRADOS:\033[1;36m[\e[1;97m $expi \033[1;36m]"
}
#BLOQUEADOS
[[ -e /etc/ElementManager/temp/USRbloqueados ]] && {
  bloc=$(cat /etc/ElementManager/temp/USRbloqueados)
...
canbio_color() {
  ...
  msg -bar2
  msg -tit
  msg -ama "     CONTROLADOR DE COLORES DEL ELEMENT MANAGER"
  msg -bar2
  ...
  echo "$cores" >/etc/ElementManager/colors
  msg -bar2
}
...
fun_autorun() {
  if [[ -e /etc/bash.bashrc-bakup ]]; then
    ...
    cat /etc/bash.bashrc | grep -v "/etc/ElementManager/menu.sh" >/tmp/bash
    ...
    echo '/etc/ElementManager/menu.sh' >>/etc/bash.bashrc.2
...
speed_test() {
  ...
  wget -O /opt/speed/speedtest https://raw.githubusercontent.com/IntelectoDev/ElementManager/master/Ejecutables/speedtest.py &>/dev/null
  chmod +rwx /opt/speed/speedtest
  declare -A cor=([0]="\033[1;37m" [1]="\033[1;34m" [2]="\033[1;31m" [3]="\033[1;33m" [4]="\033[1;32m")

  echo -e "\e[1;93m    PRUEBA DE VELOCIDAD DE HOSTING  [By ELEMENT]"
  msg -bar
...
hora_local() {
  ...
  timedo() {
    ...
    echo -e "\e[1;92m          >> FECHA LOCAL DO APLICADA! <<"
    echo -e "\e[93m           $(date)"
    msg -bar
    read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
    herramientas_fun
  ...
  echo -e "\e[1;93m  [\e[1;32m6\e[1;93m]\033[1;31m > \e[1;97mCAMBIAR HORA LOCAL DO"
  msg -bar
...
ajuste_in() {
  ...
  pamcrack() { #DESACTIVAR PASS ALFANUMERICO
    ...
    [[ $x = @(n|N) ]] && msg -bar && return
    echo -e ""
    wget -O /etc/pam.d/common-password https://raw.githubusercontent.com/IntelectoDev/ElementManager/master/Ejecutables/common-password &>/dev/null
...
fai2ban_fun() {
  ...
  remove_fail2ba() {
    ...
    rm -rf /etc/ElementManager/fail2ban &>/dev/null
...
noti_bot() {
  add_id() {
    ...
    echo "$idtele" >/etc/ElementManager/temp/idtelegram
    echo "-100$idgrupo" >/etc/ElementManager/temp/idgrupo
    echo "$nomvps" >/etc/ElementManager/temp/vpstelegram
    msg -bar
  }
  del_noti() {
    echo -e "\033[1;37mREGISTRO DE NOTIBOT BORRADO \e[1;32m"
    echo "00000000" >/etc/ElementManager/temp/idtelegram
    echo "00000000" >/etc/ElementManager/temp/vpstelegram
    echo "00000000" >/etc/ElementManager/temp/idgrupo
    msg -bar
  }
  msg_test() {
    echo -e "\033[1;32m     SE ENVIO UN MESAJE DE PRUEBA AL BOT\n\e[1;93m              >> @NearMod_Noty_bot \e[1;32m"

    NOM=$(less /etc/ElementManager/temp/idtelegram) >/dev/null 2>&1
    ID=$(echo $NOM) >/dev/null 2>&1
    NOMG=$(less /etc/ElementManager/temp/idgrupo) >/dev/null 2>&1
    IDG=$(echo $NOMG) >/dev/null 2>&1
    NOM2=$(less /etc/ElementManager/temp/vpstelegram) >/dev/null 2>&1
...
token_ge() {
  ...
  echo "$passgeneral" >/etc/ElementManager/temp/.passw
  msg -bar
  read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
  herramientas_fun
}
...
recuperar_base() {
  ...
  msg -bar2
  rm -rf /etc/ElementManager/backuplog/principal >/dev/null 2>&1
  i="1"
  [[ -z $(ls /etc/ElementManager/backuplog) ]] && echo -e "" || {
    for my_arqs in $(ls /etc/ElementManager/backuplog); do
      [[ -d "$my_arqs" ]] && continue
      select_arc[$i]="$my_arqs"
    ...
    cd /etc/ElementManager/backuplog
    file="$backselect"
    tar -xzvf ./$file
    cat /etc/ElementManager/backuplog/principal/cuentassh >/etc/ElementManager/cuentassh
    cat /etc/ElementManager/backuplog/principal/cuentahwid >/etc/ElementManager/cuentahwid
    cat /etc/ElementManager/backuplog/principal/cuentatoken >/etc/ElementManager/cuentatoken
    cd
    msg -bar
    echo -e "\e[1;32m  >> Completado con Exito!"
  }
...
chekc_users() {
  ...
  fun_initcheck() {
    ...
    if [[ "$resposta" = '1' ]]; then
      if ps x | grep -w checkuser | grep -v grep 1>/dev/null 2>/dev/null; then
        ...
        verif_ptrs $porta
        fun_check() {
          screen -dmS checkuser python3 /etc/ElementManager/filespy/check.py $porta 1
          [[ $(grep -wc "check.py" /etc/autostart) = '0' ]] && {
            echo -e "netstat -tlpn | grep -w $porta > /dev/null || {  screen -r -S 'ws' -X quit;  screen -dmS checkuser python3 /etc/ElementManager/filespy/check.py $porta 1; }" >>/etc/autostart
          } || {
            sed -i '/check.py/d' /etc/autostart
            echo -e "netstat -tlpn | grep -w $porta > /dev/null || {  screen -r -S 'ws' -X quit;  screen -dmS checkuser python3 /etc/ElementManager/filespy/check.py $porta 1; }" >>/etc/autostart
          }
        ...
        fun_check2() {
          screen -dmS checkuser python3 /etc/ElementManager/filespy/4gcheck.py $porta 2
          [[ $(grep -wc "4gcheck.py" /etc/autostart) = '0' ]] && {
            echo -e "netstat -tlpn | grep -w $porta > /dev/null || {  screen -r -S 'ws' -X quit;  screen -dmS checkuser python3 /etc/ElementManager/filespy/check.py $porta 2; }" >>/etc/autostart
          } || {
      ...
      if ps x | grep -w 4gcheck | grep -v grep 1>/dev/null 2>/dev/null; then
        ...
        verif_ptrs $porta
        fun_udpon() {
          screen -dmS 4gcheck python3 /etc/ElementManager/filespy/4gcheck.py $porta
          [[ $(grep -wc "4gcheck.py" /etc/autostart) = '0' ]] && {
            echo -e "netstat -tlpn | grep -w $porta > /dev/null || {  screen -r -S 'ws' -X quit;  screen -dmS checkuser python3 /etc/ElementManager/filespy/4gcheck.py $porta; }" >>/etc/autostart
          } || {
            sed -i '/check.py/d' /etc/autostart
            echo -e "netstat -tlpn | grep -w $porta > /dev/null || {  screen -r -S 'ws' -X quit;  screen -dmS checkuser python3 /etc/ElementManager/filespy/4gcheck.py $porta; }" >>/etc/autostart
          }
  ...
  inst_depedencias() {
    ...
    # download check.py
    [[ -e "/etc/ElementManager/filespy/check.py" ]] && {
      sleep 0.1
    } || {
      cd $HOME
      wget https://raw.githubusercontent.com/IntelectoDev/ElementManager/master/Ejecutables/check.py -o /dev/null
      mv -f $HOME/check.py /etc/ElementManager/filespy/check.py
    }

    [[ -e "/etc/ElementManager/filespy/4gcheck.py" ]] && {
      sleep 0.1
    } || {
      cd $HOME
      wget https://raw.githubusercontent.com/IntelectoDev/ElementManager/master/Ejecutables/4gcheck.py -o /dev/null
      mv -f $HOME/4gcheck.py /etc/ElementManager/filespy/4gcheck.py
    }
    ...
    [[ -e "/bin/check" ]] && {
      ...
      cd $HOME
      wget https://raw.githubusercontent.com/IntelectoDev/ElementManager/master/Ejecutables/check -o /dev/null
      mv -f $HOME/check /bin/check
      chmod 777 /bin/check
    }
  }

  [[ -e "/etc/ElementManager/filespy/check.py" ]] && [[ -e "/etc/ElementManager/filespy/4gcheck.py" ]] && [[ -e "/bin/check" ]] && {
    fun_initcheck
  } || {
...
monservi_fun() {
  ...
  #MONITOREAR
  monssh() {
    echo "resetssh" >/etc/ElementManager/temp/monitorpt
  }
  mondropbear() {
    echo "resetdropbear" >>/etc/ElementManager/temp/monitorpt
  }
  monssl() {
    echo "resetssl" >>/etc/ElementManager/temp/monitorpt
  }
  monsquid() {
    echo "resetsquid" >>/etc/ElementManager/temp/monitorpt
  }
  monapache() {
    echo "resetapache" >>/etc/ElementManager/temp/monitorpt
  }
  monv2ray() {
    echo "resetv2ray" >>/etc/ElementManager/temp/monitorpt
  }
  monwebsoket() {
    echo "resetwebp" >>/etc/ElementManager/temp/monitorpt
  }
  msg -bar
  msg -tit
  msg -bar
  ...
  if [[ -z $PIDVRF3 ]]; then
    ...
    echo "null" >/etc/ElementManager/temp/monitorpt
    ...
    error() {
      ...
      tput dl1
      tiemmoni="120"
      echo "${tiemmoni}" >/etc/ElementManager/temp/T-Mon
    ...
    echo "${tiemmoni}" >/etc/ElementManager/temp/T-Mon
    screen -dmS monitorproto watch -n $tiemmoni /etc/ElementManager/menu.sh "monitorservi"
  else
...
monitor_auto() {
  for servicex in $(cat /etc/ElementManager/temp/monitorpt); do
    rebootnb $servicex
  done
}
...
autolimpieza_fun() {
  ...
  if [[ -z $PIDVRF4 ]]; then
    ...
    echo ""
    echo -e "\033[97m >> Actualizar Paquetes"
    ...
    echo ""
    screen -dmS autolimpieza watch -n 43200 /etc/ElementManager/menu.sh "autolim"
  else
...
creditoss() {
  ...
  msg -bar
  echo -ne "\033[1;97m            \e[100m CAMBIOS DE ELEMENT MANAGER \e[0;97m \n"
  registro=$(curl -sSL "https://raw.githubusercontent.com/IntelectoDev/ElementManager/master/cambios")
  echo -ne "$registro"
  msg -bar
  echo -e "  \e[48;5;1m\e[38;5;15m          ❗️ ⚠️  ELEMENT SE DESLIGA ⚠️ ❗️            \e[0;97m\n"
  echo -e "\033[1;33m >> Del mal uso a este panel VPN"
  echo -e "\033[1;33m >> El uso incorrecto a redes de terceros "
...
proto_dropbear() {
  activar_dropbear() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;93m         INSTALADOR DROPBEAR | ELEMENT MANAGER"
    msg -bar
...
proto_ssl() {
  ...
  ssl_stunel() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;93m             INSTALADOR SSL ELEMENT MANAGER"
    msg -bar
    ...
    msg -bar
    rm -rf /etc/ElementManager/stunnel.crt >/dev/null 2>&1
    rm -rf /etc/ElementManager/stunnel.key >/dev/null 2>&1
...
<IfModule mod_gnutls.c>
      ...
      for port in $(cat /etc/ElementManager/PortM/PDirect.log | grep -v "nobody" | cut -d' ' -f1); do
        PIDVRF3="$(ps aux | grep pid-"$port" | grep -v grep | awk '{print $2}')"
        Portd="$(cat /etc/ElementManager/PortM/PDirect.log | grep -v "nobody" | cut -d' ' -f1)"
        if [[ -z ${Portd} ]]; then
          # systemctl start python.PD &>/dev/null
          screen -dmS pydic-"$port" python /etc/ElementManager/filespy/PDirect-8081.py
        else
          # systemctl start python.PD &>/dev/null
          screen -dmS pydic-"$port" python /etc/ElementManager/filespy/PDirect-8081.py
        fi
  ...
  msg -tit
  msg -bar
  echo -e "\e[1;93m    INSTALADOR MONO Y MULTI SSL | ELEMENT MANAGER"
  msg -bar
...
proto_squid() {
  ...
  fun_squid() {
    ...
    msg -tit
    msg -bar
    msg -ama "         INSTALADOR SQUID | ELEMENT MANAGER "
    msg -bar
    fun_ip
...
#portas" >$var_squid
      ...
      echo -e "
#nome
visible_hostname ElementManager
...
Necesitas habilitar TUN antes de usar este script"
  ...
  meu_ip() {
    if [[ -e /etc/ElementManager/MEUIPvps ]]; then
      echo "$(cat /etc/ElementManager/MEUIPvps)"
    else
      MEU_IP=$(ip addr | grep 'inet' | grep -v inet6 | grep -vE '127\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}' | grep -o -E '[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}' | head -1)
      MEU_IP2=$(wget -qO- ipv4.icanhazip.com)
      [[ "$MEU_IP" != "$MEU_IP2" ]] && echo "$MEU_IP2" || echo "$MEU_IP"
...
exit 0' >$RCLOCAL
    ...
    #
    echo "# OVPN_ACCESS_SERVER_PROFILE=ELEMENT
client
dev tun
proto $PROTOCOL
sndbuf 0
...
auth-user-pass" >/etc/openvpn/client-common.txt
  ...
  instala_ovpn() {
    ...
    coleta_variaveis() {
      echo -e "\033[1;32m     INSTALADOR DE OPENVPN | ELEMENT"
      msg -bar
...
# OVPN_ACCESS_SERVER_PROFILE=ELEMENT
client
nobind
dev tun
...
proto_badvpn() {
  activar_badvpn() {
    ...
    echo "$portasx" >/etc/ElementManager/PortM/Badvpn.log
    msg -bar
    totalporta=($portasx)
    unset PORT
    for ((i = 0; i < ${#totalporta[@]}; i++)); do
  ...
  desactivar_badvpn() {
    ...
    rm -rf /etc/ElementManager/PortM/Badvpn.log >/dev/null 2>&1
  ...
  if [[ ! -e /bin/badvpn-udpgw ]]; then
    wget -O /bin/badvpn-udpgw https://raw.githubusercontent.com/IntelectoDev/ElementManager/master/Ejecutables/badvpn-udpgw &>/dev/null
...
proto_shadowsockN() {
  ...
  fun_shadowsocks() {
    ...
    while true; do
      ...
      msg -tit
      msg -bar
      msg -ama "      INSTALADOR SHADOWSOCKS | ELEMENT MANAGER"
      msg -bar
...
EOF
    ...
    install_prepare_password() {
      echo -ne "\033[1;97m Digite una contraseña:\033[1;32m" && read -p " " -e -i element shadowsockspwd
      [ -z "${shadowsockspwd}" ] && shadowsockspwd="element"
      msg -bar
  ...
  fun_shadowsocks() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;93m INSTALADOR SHADOWSOCK-LIBEV+(obfs) | ELEMENT MANAGER"
    msg -bar
    instaladossb_fun
...
proto_websockete() {
  ...
  activar_websokete() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m  INSTALADOR DE WEBSOCKET EDITABLE | ELEMENT MANAGER \033[1;37m"
    msg -bar
    porta_socket=
    ...
    msg -bar
    (
      less <<PYTHON >/etc/ElementManager/filespy/PDirect-$porta_socket.py
...
PYTHON
    ...
    chmod +x /etc/ElementManager/filespy/PDirect.py
    screen -dmS pydic-"$porta_socket" python /etc/ElementManager/filespy/PDirect-$porta_socket.py && echo "$porta_socket" >>/etc/ElementManager/PortM/PDirect.log
  ...
  desactivar_websokete() {
    ...
    msg -bar
    for portdic in $(cat /etc/ElementManager/PortM/PDirect.log); do
    ...
    rm -rf /etc/ElementManager/filespy/PDirect-$portselect.py >/dev/null 2>&1
    sed -i '/'$portselect'/d' /etc/ElementManager/PortM/PDirect.log >/dev/null 2>&1
    msg -bar
...
proto_popenvpn() {
  activar_openvpn() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE PROXY OPENVPN | ELEMENT MANAGER \033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
      echo -ne "\033[1;97m Digite el Puerto para el Websoket:\033[1;92m" && read -p " " -e -i "8081" porta_socket
    ...
    echo -ne "\033[1;97m Introduzca el texto de estado plano o en HTML:\n \033[1;31m" && read -p " " -e -i "By ELEMENT | MANAGER" texto_soket
    msg -bar
    screen -dmS popenvpn-"$porta_socket" python /etc/ElementManager/filespy/POpen.py "$porta_socket" "$texto_soket" && echo ""$porta_socket"" >>/etc/ElementManager/PortM/POpen.log
  ...
  desactivar_popen() {
    ...
    rm -rf /etc/ElementManager/PortM/POpen.log >/dev/null 2>&1
...
proto_ppublico() {
  ...
  activar_ppublico() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE PROXY PUBLICO | ELEMENT MANAGER \033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
    ...
    echo -ne "\033[1;97m Introduzca el texto de estado plano o en HTML:\n \033[1;31m" && read -p " " -e -i "By ELEMENT | MANAGER" texto_soket
    msg -bar
    screen -dmS ppublico-"$porta_socket" python /etc/ElementManager/filespy/PPub.py "$porta_socket" "$texto_soket" && echo ""$porta_socket"" >>/etc/ElementManager/PortM/PPub.log
  ...
  desactivar_ppublico() {
    ...
    msg -bar
    echo -e "\033[1;97m Procesando ...."
    rm -rf /etc/ElementManager/PortM/PPub.log >/dev/null 2>&1
...
proto_pprivado() {
  activar_pprivado() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE PROXY PRIVADO | ELEMENT MANAGER \033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
    ...
    echo -ne "\033[1;97m Introduzca el texto de estado plano o en HTML:\n \033[1;31m" && read -p " " -e -i "By ELEMENT | MANAGER" texto_soket
    msg -bar
    screen -dmS pprivado-"$porta_socket" python3 /etc/ElementManager/filespy/PPriv.py "$porta_socket" "$texto_soket" "$IP" && echo ""$porta_socket"" >>/etc/ElementManager/PortM/PPriv.log
  ...
  desactivar_pprivado() {
    ...
    msg -bar
    echo -e "\033[1;97m Procesando ...."
    rm -rf /etc/ElementManager/PortM/PPriv.log >/dev/null 2>&1
...
proto_pgettunel() {
  activar_gettunel() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE GETTUNEL | ELEMENT MANAGER \033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
    ...
    msg -bar
    echo -ne "\033[1;97m Digite una contraseña:\n \033[1;31m" && read -p " " -e -i "ElementManager" passg
    echo "$passg" >/etc/ElementManager/filespy/pwd.pwd
    msg -bar
    while read service; do
      [[ -z $service ]] && break
      echo "127.0.0.1:$(echo $service | cut -d' ' -f2)=$(echo $service | cut -d' ' -f1)"
    done <<<"$(mportas)"
    screen -dmS getpy python /etc/ElementManager/filespy/PGet.py -b "0.0.0.0:porta_socket" -p "/etc/ElementManager/filespy/pwd.pwd"
...
proto_ptcpover() {
  activar_tcpover() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE TCPOVER | ELEMENT MANAGER \033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
    ...
    cd socks
    patch="https://raw.githubusercontent.com/IntelectoDev/ElementManager/master/Ejecutables/backsocz.zip"
    arq="backsocz.zip"
...
#--- SLOWN DNS
proto_slowndns() {
  mkdir -p /etc/ElementManager/temp/SlowDNS/install >/dev/null 2>&1
  mkdir -p /etc/ElementManager/temp/SlowDNS/Key >/dev/null 2>&1
  SlowDNSinstall="/etc/ElementManager/temp/SlowDNS/install"
  SlowDNSconf="/etc/ElementManager/temp/SlowDNS/Key"
  info() {
  ...
  ini_slow() {
    ...
    if [[ ! -e ${SlowDNSinstall}/dns-server ]]; then
      ...
      if wget -O ${SlowDNSinstall}/dns-server https://www.dropbox.com/s/7msk0coa957nybu/dns-server &>/dev/null; then
...
sshl_install() {
  ...
  sslh_inicial() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;93m           INSTALADOR SSLH ELEMENT MANAGER"
    msg -bar
  ...
  msg -tit
  msg -bar
  echo -e "\e[1;93m          INSTALADOR DE SSLH | ELEMENT MANAGER"
  msg -bar
...
udp_serverr() {
  ...
  activar_badvpn() {
    ...
    echo "$portasx" >/etc/ElementManager/PortM/UDP-server.log
    msg -bar
    totalporta=($portasx)
    unset PORT
    for ((i = 0; i < ${#totalporta[@]}; i++)); do
...
[Unit]
Description=UDPserver Service by ELEMENT
...
EOF
  ...
  desactivar_badvpn() {
    ...
    rm -rf /etc/ElementManager/PortM/UDP-server.log
...
server_psiphones() {
  ...
  install_psiphone() {
    ...
    msg -tit
    msg -bar
    msg -ama "            INSTALADOR DE SERVER-PSIPHONE"
    msg -bar
...
control_v2ray() {
  err_fun() {
    case $1 in
      ...
      2) msg -verm "Nombre muy corto (MIN: 2 CARACTERES)" ;;
      3) msg -verm "Nombre muy grande (MAX: 5 CARACTERES)" ;;
      4) msg -verm "Contraseña Nula" ;;
      5) msg -verm "Contraseña muy corta" ;;
      6) msg -verm "Contraseña muy grande" ;;
      7) msg -verm "Duracion Nula" ;;
      8) msg -verm "Duracion invalida utilize numeros" ;;
      9) msg -verm "Duracion maxima y de un año" ;;
      11) msg -verm "Limite Nulo" ;;
      12) msg -verm "Limite invalido utilize numeros" ;;
      13) msg -verm "Limite maximo de 999" ;;
      14) msg -verm "Usuario Ya Existe" ;;
      15) msg -verm "(Solo numeros) GB = Min: 1gb Max: 1000gb" ;;
      16) msg -verm "Solo numeros" ;;
      17) msg -verm "Sin Informacion - Para Cancelar Digite CRTL + C" ;;
    esac
    sleep 2
  ...
  intallv2ray() {
    ...
    msg -bar
    source <(curl -sL https://raw.githubusercontent.com/IntelectoDev/ElementManager/master/Ejecutables/v2ray.sh)
    v2ray update
    ...
    USRdatabase="/etc/ElementManager/RegV2ray"
  ...
  protocolv2ray() {
    msg -ama "Escoger opcion 3 y poner el dominio de nuestra IP!"
    msg -bar
    v2ray stream
    msg -bar
    read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
  ...
  unistallv2() {
    ...
    rm -rf /etc/ElementManager/RegV2ray >/dev/null 2>&1
    rm -rf /etc/ElementManager/v2ray/* >/dev/null 2>&1
  ...
  addusr() {
    ...
    ##Registro
    echo "  $UUID | $nick | $valid " >>/etc/ElementManager/RegV2ray
    Fecha=$(date +%d-%m-%y-%R)
    cp /etc/ElementManager/RegV2ray /etc/ElementManager/v2ray/RegV2ray-"$Fecha"
    cp /etc/ElementManager/RegV2ray /etc/v2ray/config.json-"$Fecha"
    v2ray restart >/dev/null 2>&1
    echo ""
    v2ray info >/etc/ElementManager/v2ray/confuuid.log
    lineP=$(sed -n '/'${UUID}'/=' /etc/ElementManager/v2ray/confuuid.log)
    numl1=4
    let suma=$lineP+$numl1
    sed -n ${suma}p /etc/ElementManager/v2ray/confuuid.log
    echo ""
    msg -bar
...
delusr() {
  ...
  invalid_uuid() {
    ...
    msg -ne "Presiona Enter para Continuar" && read enter
    control_v2ray
  }
  ...
  # Mostrar usuarios registrados enumerados
  echo -e "\e[1;97m               USUARIOS REGISTRADOS"
  while IFS= read -r line; do
    ((counter++))
    echo -e "\e[1;33m${counter}. ${line}"
    user_array[$counter]=$line
  done < <(cut -d '|' -f2,1 /etc/ElementManager/RegV2ray)

  msg -bar
  echo -ne "\e[91m >> Digita el número o nombre de usuario a eliminar:\n \033[1;92m " && read -r userv_input

  # Verificar si la entrada es un número o un nombre de usuario
  if [[ $userv_input =~ ^[0-9]+$ ]]; then
    # Si la entrada es un número, obtener el nombre de usuario correspondiente
    if ((userv_input > 0 && userv_input <= counter)); then
      userv="${user_array[$userv_input]}"
    else
      invalid_uuid
    fi
  else
    # Si la entrada no es un número, se asume que es el nombre de usuario
    userv="$userv_input"
  fi

  uuidel=$(grep -w "$userv" /etc/ElementManager/RegV2ray | cut -d'|' -f1 | tr -d " \t\n\r")

  if ! grep -q "${uuidel}" /etc/v2ray/config.json; then
    invalid_uuid
  fi

  lineP=$(grep -n "${uuidel}" /etc/v2ray/config.json | cut -d':' -f1)
  linePre=$(grep -n "${uuidel}" /etc/ElementManager/RegV2ray | cut -d':' -f1)

  sed -i "${linePre}d" /etc/ElementManager/RegV2ray
  ...
  mosusr_kk() {
    ...
    msg -bar
    VPSsec=$(date +%s)
    local HOST="/etc/ElementManager/RegV2ray"
    local HOST2="/etc/ElementManager/RegV2ray"
    ...
    if [[ -z $RETURN ]]; then
      ...
      while read hostreturn; do
        DateExp="$(cat /etc/ElementManager/RegV2ray | grep -w "$hostreturn" | cut -d'|' -f3)"
        if [[ ! -z $DateExp ]]; then
        ...
        usris="$(cat /etc/ElementManager/RegV2ray | grep -w "$hostreturn" | cut -d'|' -f2)"
      ...
      [[ ! -z $contador_secuencial ]] && {
        linesss=$(cat /etc/ElementManager/RegV2ray | wc -l)
  ...
  limpiador_activador() {
    ...
    if [[ ! $PIDGEN ]]; then
      screen -dmS limv2ray watch -n 21600 /etc/ElementManager/menu.sh "exlimv2ray"
    else
      #killall screen
  ...
  backup_fun() {
    ...
    1)
      ...
      cp /etc/ElementManager/RegV2ray $HOME/RegV2ray
    ...
    2)
      ...
      cp /root/RegV2ray /etc/ElementManager/RegV2ray
      echo -e "\033[1;31mRESTAURADO > [\033[1;32m/etc/v2ray/config.json \033[1;31m]"
      echo -e "\033[1;31mRESTAURADO > [\033[1;32m/etc/ElementManager/RegV2ray \033[1;31m]"
      ;;
    3)
...
controlador_ssr() {
 ...
 En el navegador, abra el enlace del codigo QR, puede\n ver la imagen del codigo QR."
  ...
  Set_config_user() {
    ...
    msg -bar
    read -p "(Predeterminado: ELEMENT):" ssr_user
    [[ -z "${ssr_user}" ]] && ssr_user="ELEMENT"
  ...
  Set_config_password() {
    ...
    msg -bar
    read -p "(Predeterminado: ELEMENT):" ssr_password
    [[ -z "${ssr_password}" ]] && ssr_password="ELEMENT"
...
controlador_ssh() {
  # Obteniendo la dirección IP y la interfaz de red
  myip=$(ip route get 1 | awk '{print $NF;exit}')
  myint=$(ip -o -4 route show to default | awk '{print $5}')
  ...
  # Comprobando si los procesos están en ejecución
  VERY=$(pgrep -af "/etc/ElementManager/menu.sh verificar")
  VERY2=$(pgrep -af "/etc/ElementManager/menu.sh desbloqueo")
  ...
  eliminar_all() {
    ...
    rm -rf /etc/ElementManager/cuentassh &>/dev/null
    rm -rf /etc/ElementManager/cuentahwid &>/dev/null
    rm -rf /etc/ElementManager/cuentatoken &>/dev/null
    service sshd restart &>/dev/null
    service ssh restart &>/dev/null
    service dropbear start &>/dev/null
    service stunnel4 start &>/dev/null
    service squid restart &>/dev/null
    rm -rf /etc/ElementManager/temp/userlock &>/dev/null
    rm -rf /etc/ElementManager/temp/Limiter.log &>/dev/null
    unlockall2
    msg -bar
    read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
    controlador_ssh
  ...
  reset_contador() {
    ...
    msg -bar
    read -p "        ►► Presione enter para continuar ◄◄"
    rm -rf /etc/ElementManager/temp/userlock
    rm -rf /etc/ElementManager/temp/Limiter.log
    unlockall2
    msg -bar
  ...
  block_userfun() {
    local USRloked="/etc/ElementManager/temp/userlock"
    local LIMITERLOG="/etc/ElementManager/temp/Limiter.log"
    local LIMITERLOG2="/etc/ElementManager/temp/Limiter2.log"
    if [[ $2 = "-loked" ]]; then
  ...
  block_user() {
    ...
    ##-->>LECTOR DE CUENTAS
    if [[ -e "/etc/ElementManager/cuentassh" ]]; then
      readarray -t usuarios_ativos1 < <(cut -d '|' -f1 /etc/ElementManager/cuentassh)
      readarray -t usuarios_ativosf2 < <(cut -d '|' -f2 /etc/ElementManager/cuentassh)
    fi
    if [[ -e "/etc/ElementManager/cuentahwid" ]]; then
      readarray -t usuarios_ativos2 < <(cut -d '|' -f1 /etc/ElementManager/cuentahwid)
    fi
    if [[ -e "/etc/ElementManager/cuentatoken" ]]; then
      readarray -t usuarios_ativos3 < <(cut -d '|' -f1 /etc/ElementManager/cuentatoken)
    fi
    ##-->>GENERAR USUARIOS TOTALES
    cat /etc/ElementManager/cuentassh /etc/ElementManager/cuentahwid /etc/ElementManager/cuentatoken 2>/dev/null | cut -d '|' -f1 >/etc/ElementManager/cuentasactivast
    if [[ -e "/etc/ElementManager/cuentasactivast" ]]; then
      readarray -t mostrar_totales < <(cut -d '|' -f1 /etc/ElementManager/cuentasactivast)
    fi
    ...
    if [[ -z ${mostrar_totales[@]} ]]; then
      ...
      for us in $(echo ${usuarios_ativos2[@]}); do
        if [[ $(cat ${USRloked} | grep -w "${us}") ]]; then
          nomhwid="$(cat /etc/ElementManager/cuentahwid | grep -w "${us}" | cut -d'|' -f5)"
      ...
      for us in $(echo ${usuarios_ativos3[@]}); do
        if [[ $(cat ${USRloked} | grep -w "${us}") ]]; then
          nomtoken="$(cat /etc/ElementManager/cuentatoken | grep -w "${us}" | cut -d'|' -f5)"
  ...
  add_user() {
    ...
    echo "$1|$2|${datexp}|$4" >>/etc/ElementManager/cuentassh
    echo "$1|$2|${datexp}|$4" >>/etc/ElementManager/regtotal
    echo "" >/dev/null 2>&1
  }
  ...
  renew_user_fun() {
    ...
    sed -i '/'$1'/d' /etc/ElementManager/temp/userexp 2>/dev/null
    ##-->>LECTOR DE CUENTAS
    if [[ -e "/etc/ElementManager/cuentassh" ]]; then
      readarray -t usuarios_ativos1 < <(cut -d '|' -f1 /etc/ElementManager/cuentassh)
      readarray -t usuarios_ativosf2 < <(cut -d '|' -f2 /etc/ElementManager/cuentassh)
    ...
    if [[ -z ${usuarios_ativos1[@]} ]]; then
      ...
      [[ $(grep -o -i $1 /etc/ElementManager/cuentassh) ]] && {
        pass=$(cat /etc/ElementManager/cuentassh | grep -w "$1" | cut -d'|' -f2)
        limit=$(cat /etc/ElementManager/cuentassh | grep -w "$1" | cut -d'|' -f4)
        userb=$(cat /etc/ElementManager/cuentassh | grep -n -w $1 | cut -d'|' -f1 | cut -d':' -f1)
        sed -i "${userb}d" /etc/ElementManager/cuentassh
        echo "$1|$pass|${datexp}|$limit|$userb" >>/etc/ElementManager/cuentassh
      }
    fi
    #HWID
    if [[ -z ${usuarios_ativos2[@]} ]]; then
      ...
      [[ $(grep -o -i $1 /etc/ElementManager/cuentahwid) ]] && {
        nomhwid="$(cat /etc/ElementManager/cuentahwid | grep -w "$1" | cut -d'|' -f5)"
        sed -i '/'$1'/d' /etc/ElementManager/cuentahwid
        echo "$1||${datexp}||$nomhwid" >>/etc/ElementManager/cuentahwid
      }
    fi
    #TOKEN
    if [[ -z ${usuarios_ativos3[@]} ]]; then
      ...
      [[ $(grep -o -i $1 /etc/ElementManager/cuentatoken) ]] && {
        nomtoken="$(cat /etc/ElementManager/cuentatoken | grep -w "$1" | cut -d'|' -f5)"
        sed -i '/'$1'/d' /etc/ElementManager/cuentatoken
        echo "$1||${datexp}||$nomtoken" >>/etc/ElementManager/cuentatoken
      }
    fi
    echo "" >/dev/null 2>&1
  }
  ...
  new_user() {
    ...
    cuenta_hwid() {
      ...
      echo "$nomeuser||${datexp}||${nickhwid}" >>/etc/ElementManager/cuentahwid
      echo "$nomeuser||${datexp}||${nickhwid}" >>/etc/ElementManager/regtotal
    ...
    cuenta_token() {
      ...
      [[ -e "/etc/ElementManager/temp/.passw" ]] || passgeneral
      while true; do
      ...
      echo -ne "\e[38;5;202mFecha de Expiracion: \e[1;97m" && echo -e "$(date "+%F" -d " + $diasuser days")"
      msg -bar
      passtoken=$(cat /etc/ElementManager/temp/.passw | tr -d " \t\n\r")
      ...
      echo "$nomeuser||${datexp}||${nickhwid}" >>/etc/ElementManager/cuentatoken
      echo "$nomeuser||${datexp}||${nickhwid}" >>/etc/ElementManager/regtotal
      msg -ama "\e[1;32m            Usuario Creado con Exito"
      rebootnb "backbaseu" 2>/dev/null
  ...
  remove_user() {
    ...
    if [[ -z ${usuarios_ativos1[@]} ]]; then
      ...
      [[ $(grep -o -i $usuario_del /etc/ElementManager/cuentassh) ]] && {
        userb=$(cat /etc/ElementManager/cuentassh | grep -n -w $usuario_del | cut -d'|' -f1 | cut -d':' -f1)
        sed -i "${userb}d" /etc/ElementManager/cuentassh >/dev/null 2>&1
      }
    fi
    #HWID
    if [[ -z ${usuarios_ativos2[@]} ]]; then
      ...
      [[ $(grep -o -i $usuario_del /etc/ElementManager/cuentahwid) ]] && {
        sed -i '/'$usuario_del'/d' /etc/ElementManager/cuentahwid >/dev/null 2>&1
      }
    fi
    #TOKEN
    if [[ -z ${usuarios_ativos3[@]} ]]; then
      ...
      [[ $(grep -o -i $usuario_del /etc/ElementManager/cuentatoken) ]] && {
        sed -i '/'$usuario_del'/d' /etc/ElementManager/cuentatoken >/dev/null 2>&1
      }
    fi
  ...
  renew_user() {
    ...
    if [[ -z ${mostrar_totales[@]} ]]; then
      ...
      for us in $(echo ${usuarios_ativos1[@]}); do
        VPSsec=$(date +%s)
        DateExp="$(cat /etc/ElementManager/cuentassh | grep -w "${us}" | cut -d'|' -f3)"
        DataSec=$(date +%s --date="$DateExp")
      ...
      for us in $(echo ${usuarios_ativos2[@]}); do
        VPSsec=$(date +%s)
        DateExp="$(cat /etc/ElementManager/cuentahwid | grep -w "${us}" | cut -d'|' -f3)"
        DataSec=$(date +%s --date="$DateExp")
        if [[ "$VPSsec" -gt "$DataSec" ]]; then
          EXPTIME="${red}[Exp]"
        else
      ...
      for us in $(echo ${usuarios_ativos3[@]}); do
        VPSsec=$(date +%s)
        DateExp="$(cat /etc/ElementManager/cuentatoken | grep -w "${us}" | cut -d'|' -f3)"
        DataSec=$(date +%s --date="$DateExp")
        if [[ "$VPSsec" -gt "$DataSec" ]]; then
          EXPTIME="${red}[Exp]"
        else
  ...
  edit_user() {
    ...
    edit_user_fun "${useredit}" "${senhauser}" "${diasuser}" "${limiteuser}" && echo -e "\e[1;32m      Usuario Modificado Con Exito" && rm -rf /etc/ElementManager/temp/Limiter.log || msg -verm "Error, Usuario nao Modificado"
    msg -bar
    read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
    controlador_ssh
  }
  ...
  detail_user() {
    ...
    if [[ -z ${mostrar_totales[@]} ]]; then
      ...
      #CUENTAS SSH
      mostrar_usuariosssh() {
        for u in $(cat /etc/ElementManager/cuentassh | cut -d'|' -f1); do
          echo "$u"
        done
      }
      [[ -e "/etc/ElementManager/cuentassh" ]] && usuarios_ativos1=($(mostrar_usuariosssh))
      if [[ -z ${usuarios_ativos1[@]} ]]; then
        echo "" >/dev/null 2>&1
      else
        echo -e "\033[38;5;239m════════════════\e[100m\e[97m  CUENTAS NORMALES  \e[0m\e[38;5;239m════════════════"
        while read user; do
          ...
          if [[ -e "/etc/ElementManager/cuentassh" ]]; then
            if [[ $(cat /etc/ElementManager/cuentassh | grep -w "${user}") ]]; then
              txtvar+="$(printf '%-22s' "${yellow}$(cat /etc/ElementManager/cuentassh | grep -w "${user}" | cut -d'|' -f2)")"
              DateExp="$(cat /etc/ElementManager/cuentassh | grep -w "${user}" | cut -d'|' -f3)"
              DataSec=$(date +%s --date="$DateExp")
              if [[ "$VPSsec" -gt "$DataSec" ]]; then
                EXPTIME="${red}[Exp]"
              else
              ...
              txtvar+="$(printf '%-1s' "\e[1;36m$(cat /etc/ElementManager/cuentassh | grep -w "${user}" | cut -d'|' -f4)")"
            else
      ...
      mostrar_usuarioshwid() {
        for u in $(cat /etc/ElementManager/cuentahwid | cut -d'|' -f1); do
          echo "$u"
        done
      }
      [[ -e "/etc/ElementManager/cuentahwid" ]] && usuarios_ativos2=($(mostrar_usuarioshwid))
      if [[ -z ${usuarios_ativos2[@]} ]]; then
        echo "" >/dev/null 2>&1
      else
        echo -e "\033[38;5;239m════════════════\e[100m\e[97m  CUENTAS CON HWID  \e[0m\e[38;5;239m════════════════"
        while read user; do
          ...
          nomhwid="$(printf '%-18s' "\e[1;36m$(cat /etc/ElementManager/cuentahwid | grep -w "${user}" | cut -d'|' -f5)")"
          if [[ -e "/etc/ElementManager/cuentahwid" ]]; then
            if [[ $(cat /etc/ElementManager/cuentahwid | grep -w "${user}") ]]; then
              #txtvar+="$(printf '%-18s' "${yellow}$(cat ${USRdatabase} | grep -w "${user}" | cut -d'|' -f2)")"
              DateExp="$(cat /etc/ElementManager/cuentahwid | grep -w "${user}" | cut -d'|' -f3)"
              DataSec=$(date +%s --date="$DateExp")
              if [[ "$VPSsec" -gt "$DataSec" ]]; then
                EXPTIME="${red}[Exp]"
              else
              ...
              txtvar+="$(printf '%-25s' "${red}${DateExp}${EXPTIME}")"
              txtvar+="$(printf '%-1s' "\e[1;36m$(cat /etc/ElementManager/cuentahwid | grep -w "${user}" | cut -d'|' -f4)")"
            else
              txtvar+="$(printf '%-21s' "${red}")"
              txtvar+="$(printf '%-29s' "${red}")"
              txtvar+="$(printf '%-5s' "${red}")"
      ...
      mostrar_usuariotoken() {
        for u in $(cat /etc/ElementManager/cuentatoken | cut -d'|' -f1); do
          echo "$u"
        done
      }
      [[ -e "/etc/ElementManager/cuentatoken" ]] && usuarios_ativos3=($(mostrar_usuariotoken))
      if [[ -z ${usuarios_ativos3[@]} ]]; then
        echo "" >/dev/null 2>&1
      else
        echo -e "\033[38;5;239m════════════════\e[100m\e[97m  CUENTAS CON TOKEN \e[0m\e[38;5;239m═══════════════"
        while read user; do
          ...
          if [[ -e "/etc/ElementManager/cuentatoken" ]]; then
            if [[ $(cat /etc/ElementManager/cuentatoken | grep -w "${user}") ]]; then
              #txtvar+="$(printf '%-18s' "${yellow}$(cat ${USRdatabase} | grep -w "${user}" | cut -d'|' -f2)")"
              txtvar+="$(printf '%-18s' "\e[1;36m$(cat /etc/ElementManager/cuentatoken | grep -w "${user}" | cut -d'|' -f5)")"
              DateExp="$(cat /etc/ElementManager/cuentatoken | grep -w "${user}" | cut -d'|' -f3)"
              DataSec=$(date +%s --date="$DateExp")
              if [[ "$VPSsec" -gt "$DataSec" ]]; then
                EXPTIME="${red}[Exp]"
              else
              ...
              txtvar+="$(printf '%-25s' "${red}${DateExp}${EXPTIME}")"
              txtvar+="$(printf '%-1s' "\e[1;36m$(cat /etc/ElementManager/cuentatoken | grep -w "${user}" | cut -d'|' -f4)")"
            else
              txtvar+="$(printf '%-21s' "${red}")"
              txtvar+="$(printf '%-29s' "${red}")"
              txtvar+="$(printf '%-5s' "${red}")"
  ...
  monit_user() {
    ...
    [[ -e "/etc/ElementManager/cuentassh" ]] && usuarios_ativos1=($(mostrar_usuariossh))
    [[ -e "/etc/ElementManager/cuentahwid" ]] && usuarios_ativos2=($(mostrar_usuariohwid))
    [[ -e "/etc/ElementManager/cuentatoken" ]] && usuarios_ativos3=($(mostrar_usuariotoken))

    for us in $(echo ${usuarios_ativos1[@]}); do
      echo "${us}"
    done >/etc/ElementManager/cuentasactivast
    for us in $(echo ${usuarios_ativos2[@]}); do
      echo "${us}"
    done >>/etc/ElementManager/cuentasactivast
    for us in $(echo ${usuarios_ativos3[@]}); do
    ...
    mostrar_totales() {
      for u in $(cat /etc/ElementManager/cuentasactivast | cut -d'|' -f1); do
        echo "$u"
      done
    }
      ...
      if [[ -z ${usuarios_ativos1[@]} ]]; then
        ...
        while read user; do
          _=$(
            ...
            [[ -z $(cat /etc/ElementManager/cuentassh | grep -w "${user}") ]] && MAXUSER="?" || MAXUSER="$(cat /etc/ElementManager/cuentassh | grep -w "${user}" | cut -d'|' -f4)"
      ...
      if [[ -z ${usuarios_ativos2[@]} ]]; then
        ...
        while read user; do
          _=$(
            ...
            [[ $(dpkg --get-selections | grep -w "openvpn" | head -1) ]] && [[ -e /etc/openvpn/openvpn-status.log ]] && [[ $(openvpn_pids | grep -w "$user" | cut -d'|' -f2) ]] && PID+="$(openvpn_pids | grep -w "$user" | cut -d'|' -f2)+"
            PID+="0"
            nomhwid="\e[1;96m$(cat /etc/ElementManager/cuentahwid | grep -w "${user}" | cut -d'|' -f5)"
            [[ -z $(cat /etc/ElementManager/cuentahwid | grep -w "${user}") ]] && MAXUSER="?" || MAXUSER="$(cat /etc/ElementManager/cuentahwid | grep -w "${user}" | cut -d'|' -f4)"
            [[ $(echo $PID | bc) -gt 0 ]] && user="$user \e[1;93m[\033[1;32m ON \e[1;93m]" || user="$user \e[1;93m[\033[1;31m OFF \e[1;93m]"
      ...
      if [[ -z ${usuarios_ativos3[@]} ]]; then
        ...
        while read user; do
          _=$(
            ...
            [[ $(dpkg --get-selections | grep -w "openvpn" | head -1) ]] && [[ -e /etc/openvpn/openvpn-status.log ]] && [[ $(openvpn_pids | grep -w "$user" | cut -d'|' -f2) ]] && PID+="$(openvpn_pids | grep -w "$user" | cut -d'|' -f2)+"
            PID+="0"
            nomtoken="$(cat /etc/ElementManager/cuentatoken | grep -w "${user}" | cut -d'|' -f5)"
            [[ -z $(cat /etc/ElementManager/cuentatoken | grep -w "${user}") ]] && MAXUSER="?" || MAXUSER="$(cat /etc/ElementManager/cuentatoken | grep -w "${user}" | cut -d'|' -f4)"
    ...
    onlinest=$(cat /etc/ElementManager/temp/Tonli)
    msg -bar
  ...
  rm_vencidos() {
    ...
    if [[ -z ${usuarios_ativos1[@]} ]]; then
      ...
      while read user; do
        ...
        if [[ "$DataSEC" -lt "$DataVPS" ]]; then
          ...
          userb=$(cat /etc/ElementManager/cuentassh | grep -n -w $user | cut -d'|' -f1 | cut -d':' -f1)
          sed -i "${userb}d" /etc/ElementManager/cuentassh
        else
    ...
    if [[ -z ${usuarios_ativos2[@]} ]]; then
      ...
      while read user; do
        ...
        if [[ "$DataSEC" -lt "$DataVPS" ]]; then
          ...
          # kill -9 $droplim &>/dev/null
          rm_user "$user" && echo -e " y ($removido)"
          sed -i '/'$user'/d' /etc/ElementManager/cuentahwid
        else
          echo -e "\e[1;97m$usr $valid"
        fi
      done <<<"$(mostrar_usuarioshwid)"
    ...
    if [[ -z ${usuarios_ativos3[@]} ]]; then
      ...
      while read user; do
        ...
        if [[ "$DataSEC" -lt "$DataVPS" ]]; then
          ...
          # kill -9 $droplim &>/dev/null
          rm_user "$user" && echo -e "y ($removido)"
          sed -i '/'$user'/d' /etc/ElementManager/cuentatoken
        else
          echo -e "\e[1;97m$usr $valid"
        fi
      done <<<"$(mostrar_usuariotoken)"
    ...
    rm -rf /etc/ElementManager/temp/userlock
    rm -rf /etc/ElementManager/temp/userexp
    unlockall2
    msg -bar
    read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
    controlador_ssh
  ...
  backup_fun() {
    clear && clear
    backupssh() {
      rm -rf /root/backup-element/ >/dev/null 2>&1
      ...
      cp /etc/ElementManager/cuentassh /root/backup-element/cuentassh >/dev/null 2>&1
      cp /etc/ElementManager/cuentahwid /root/backup-element/cuentahwid >/dev/null 2>&1
      cp /etc/ElementManager/cuentatoken /root/backup-element/cuentatoken >/dev/null 2>&1
      cp /etc/ElementManager/temp/.passw /root/backup-element/.passw >/dev/null 2>&1
      ...
      echo ""
      sshpass -p "$passvps" scp -o "StrictHostKeyChecking no" -r /root/backup-element/ "$useroot"@"$ipvps":/root/
      msg -azu " Procedimiento Hecho con Exito, Guardado en:"
      echo ""
      echo -e "\033[1;31m   BACKUP > [\033[1;32m/root/backup-element/\033[1;31m]"
    ...
    restaurarback() {
      ...
      [[ -e /root/Backup-element.tar.gz ]] && {
        rm -rf /root/backup-element
        tar -xzvf Backup-element.tar.gz
      }
      msg -bar
      mkdir /root/users.bk
      cp /etc/passwd /etc/shadow /etc/group /etc/gshadow /root/users.bk
      cd /root/backup-element/
      cat passwd.mig >>/etc/passwd
      cat group.mig >>/etc/group
      cat shadow.mig >>/etc/shadow
      /bin/cp gshadow.mig /etc/gshadow
      cat cuentassh >/etc/ElementManager/cuentassh
      cat cuentahwid >/etc/ElementManager/cuentahwid
      cat cuentatoken >/etc/ElementManager/cuentatoken
      cat .passw >/etc/ElementManager/temp/.passw
      cd /
      tar -zxvf /root/backup-element/home.tar.gz
      echo ""
  ...
  verif_funx() {
    ...
    PIDVRF="$(ps aux | grep "/etc/ElementManager/menu.sh verificar" | grep -v grep | awk '{print $2}')"
    if [[ -z $PIDVRF ]]; then
      msg -bar
      ...
      error() {
        ...
        tput dl1
        tiemlim="120"
        echo "${tiemlim}" >/etc/ElementManager/temp/T-Lim
      ...
      echo "${tiemlim}" >/etc/ElementManager/temp/T-Lim
      screen -dmS limitador watch -n $tiemlim /etc/ElementManager/menu.sh "verificar"
    else
      for pid in $(echo $PIDVRF); do
        screen -S limitador -p 0 -X quit
      done
      [[ -e /etc/ElementManager/temp/USRonlines ]] && rm /etc/ElementManager/temp/USRonlines
      [[ -e /etc/ElementManager/temp/USRexpired ]] && rm /etc/ElementManager/temp/USRexpired
      [[ -e /etc/ElementManager/temp/USRbloqueados ]] && rm /etc/ElementManager/temp/USRbloqueados
    fi
    msg -bar
  ...
  verif2_funx() {
    ...
    PIDVRF2="$(ps aux | grep "/etc/ElementManager/menu.sh desbloqueo" | grep -v grep | awk '{print $2}')"
    if [[ -z $PIDVRF2 ]]; then
      msg -bar
      ...
      error() {
        ...
        tput dl1
        tiemdes="120"
        echo "${tiemdes}" >/etc/ElementManager/temp/T-Des
      }
      ...
      echo "${tiemdes}" >/etc/ElementManager/temp/T-Des
      screen -dmS desbloqueador watch -n $tiemdes /etc/ElementManager/menu.sh "desbloqueo"
      #screen -dmS very2 /etc/ElementManager/menu.sh desbloqueo
    else
  ...
  baner_fun() {
    banner_on() {
      clear && clear
      local="/etc/ElementManager/bannerssh"
      ...
      if [ "$(echo "$chk" | grep -v "#Banner" | grep Banner)" != "" ]; then
        ...
        echo "Banner /etc/ElementManager/bannerssh" >>/etc/ssh/sshd_config
        local="/etc/ElementManager/bannerssh"
      fi
      msg -bar
      msg -tit
      ...
      echo ""
      msg -bar
      credi="$(less /etc/ElementManager/message.txt)"
      echo "$ban_ner" >>$local
      echo '<p style="text-align: center;"><strong><span style="color: #993300;">'$credi'</span></strong></p>' >>$local
      echo '<p style="text-align: center;"><strong>ELEMENT <span style="color: #ff0000;">|</span><span style="color: #ffcc00;"> MANAGER</span></strong></p>' >>$local
      if [[ -e "$local2" ]]; then
  ...
  rec_total() {
    ...
    msg -bar
    cat /etc/ElementManager/regtotal
    msg -bar
    read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
    controlador_ssh
  }
  ...
  demo_ssh() {
    ...
    rm -rf /etc/ElementManager/temp/demo-ssh 2>/dev/null
    mkdir /etc/ElementManager/temp/demo-ssh 2>/dev/null
    SCPdir="/etc/ElementManager"
    declare -A cor=([0]="\033[1;37m" [1]="\033[1;34m" [2]="\033[1;31m" [3]="\033[1;33m" [4]="\033[1;32m")
    tmpusr() {
      time="$1"
...
exit" >/tmp/$2
    ...
    rm -rf /tmp/cmd
    touch /etc/ElementManager/temp/demo-ssh/$name
    echo "senha: $pass" >>/etc/ElementManager/temp/demo-ssh/$name
    echo "data: ($tmp)Minutos" >>/etc/ElementManager/temp/demo-ssh/$name
    msg -bar2
...
echo -e "\e[1;93m [\e[1;32m13\e[1;93m]\033[1;31m > \e[1;97m⚠️ ELIMINAR TODOS LOS USUARIOS ⚠️"
...
# Verificar si existe el archivo de log del limitador
[[ -e "/etc/ElementManager/temp/Limiter2.log" ]] && echo -e "\e[1;93m [\e[1;32m18\e[1;93m]\033[1;31m > \e[1;97mVER LOG DE LIMITADOR "
...
case "$num" in
  ...
  16) rec_total ;;
  17)
    rm -rf /etc/ElementManager/temp/Limiter2.log
  ...
  18)
    clear && clear
    msg -bar
    sed -i -e 's/^\[ \t\]*//; s/\[ \t\]*$//; /^$/d' /etc/ElementManager/temp/Limiter2.log

    if [[ -e "/etc/ElementManager/temp/Limiter2.log" ]]; then
      msg -tit
      msg -bar
      msg -ama " REGISTRO DEL LIMITADOR "
      msg -bar
      cat /etc/ElementManager/temp/Limiter2.log
      msg -bar
    fi
...
verif_fun() {
  ...
  [[ -e "/etc/ElementManager/cuentasactivast" ]] && usuarios_totales=($(mostrar_totales))
  if [[ -z ${usuarios_totales[@]} ]]; then
    echo "" >/dev/null 2>&1
  else
    ...
    while read user; do
      ...
      if [[ "$DataSEC" -lt "$TimeNOW" ]]; then
        ...
        [[ $(cat ${USRloked} | grep -w "$user") ]] || {
          ...
          echo "$user" >>/etc/ElementManager/temp/userexp
      ...
      echo "${ONLINES}0" | bc >/etc/ElementManager/temp/USRonlines

      #----CONTADOR DE LIMITE X USER
      local conexao[$user]="$(echo ${PID}0 | bc)"
      local limite[$user]="$(cat /etc/ElementManager/cuentassh | grep -w "${user}" | cut -d'|' -f4)"
      ...
      echo "${EXPIRED}0" | bc >/etc/ElementManager/temp/USRexpired
    done <<<"$(mostrar_totales)"
  fi
  sed -i '/'-loked'/d' /etc/ElementManager/temp/userlock
  BLOQUEADO="$(wc -l /etc/ElementManager/temp/userlock | awk '{print $1}')"
  BLOQUEADO2="$(echo ${BLOQUEADO} | bc)0"
  BLOQUEADO3="/10"
  echo "${BLOQUEADO2}${BLOQUEADO3}" | bc >/etc/ElementManager/temp/USRbloqueados
  sed -i -e 's/^[ \t]*//; s/[ \t]*$//; /^$/d' /etc/ElementManager/temp/userexp
  EXPIRADO="$(wc -l /etc/ElementManager/temp/userexp | awk '{print $1}')"
  EXPIRADO2="$(echo ${EXPIRADO} | bc)0"
  EXPIRADO3="/10"
  echo "${EXPIRADO2}${EXPIRADO3}" | bc >/etc/ElementManager/temp/USRexpired
    ...
    if [[ -z $RETURN ]]; then
      ...
      while read hostreturn; do
        delbug() {
          ...
          linePre=$(sed -n '/'${hostreturn}'/=' /etc/ElementManager/RegV2ray)
          sed -i "${linePre}d" /etc/ElementManager/RegV2ray
          numl1=2
...
XLLiveUD"
  ...
  Ban_BT() {
    ...
    msg -tit
    msg -bar
    echo -e "\e[1;93m              PANEL DE FIREWALL ELEMENT"
    msg -bar
    check_BT
...
Debian / Ubuntu Sistema： apt-get install iptables -y"
  ...
  resetiptables() {
    msg -bar
    echo -e "\e[1;97m           Reiniciando Iptables Espere"
...
actulizar_fun() {
  ...
  actu_fun() {
    ...
    wget -O /etc/ElementManager/menu.sh https://www.dropbox.com/s/mld782t4u08qb6z/menu.sh &>/dev/null
    chmod +rwx /etc/ElementManager/menu.sh
  ...
  msg -tit
  msg -bar
  echo -e "\a\a\a\a\e[1;93m        >>> ACTUALIZAR ELEMENT-MANAGER <<< "
  msg -bar
  echo -e "\e[1;97m Cambios Actuales"
  registro=$(curl -sSL "https://raw.githubusercontent.com/IntelectoDev/ElementManager/master/cambios")
  echo -ne "$registro"
  echo ""
  echo -e "\e[1;97m Proceder con la Actualización?"
  msg -bar
...
[[ ! -e /etc/ElementManager/temp/version_instalacion ]] && echo 1 >/etc/ElementManager/temp/version_instalacion
v11=$(cat /etc/ElementManager/temp/version_actual)
v22=$(cat /etc/ElementManager/temp/version_instalacion)
...
echo -e "\e[38;5;239m════════════════════════════════════════════════════"
echo -ne "\e[1;93m  [\e[1;32m4\e[1;93m]\033[1;31m > \e[1;97mMENU DE INSTALACIÓN\e[0;97m " && echo -ne "\e[1;93m[\e[1;32m5\e[1;93m]\033[1;31m >\e[38;5;76m PUERTOS ACTIVOS \e[0;97m\n"
...
echo -ne "\e[1;93m  [\e[1;32m8\e[1;93m]\033[1;31m > \e[1;97mCONFIGURACIÓN DE FIREWALL\e[97m \n"
